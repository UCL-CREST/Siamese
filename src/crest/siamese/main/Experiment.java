...
public class Experiment {
    ...
    private static ArrayList<EvalResult> tfidfTextExp() {
        ...
        return siamese.runExperiment(indexSettings, mappingStr, normModes, ngramSizes, cloneClusterFilePrefix);
    }
    ...
    private static ArrayList<EvalResult> tfidfExp() {
        ...
        for (String discO : discountOverlap) {
            ...
            ArrayList<EvalResult> result = siamese.runExperiment(indexSettings, mappingStr, normModes, ngramSizes, cloneClusterFilePrefix);
