...
ax.annotate(str(i+1) + '-gram ('
                    ...
                    + str(round(bellon_t2_index[i], decimal)) + ')', xy=(bellon_t2_2[i], bellon_t2_index[i]),
...
#             + str(round(bellon_t2_2[i], decimal)) + ', '
#             + str(round(bellon_t2_index[i], decimal)) + ')', xy=(bellon_t2_2[i], bellon_t2_index[i]),
#             xytext=(bellon_t2_2[i] - 0.07, bellon_t2_index[i] + 6),
#             arrowprops=dict(arrowstyle="->", connectionstyle="arc3"))
#
# i = 7
# ax.annotate('(' + str(i+1) + '-gram, '
#             + str(round(bellon_t2_2[i], decimal)) + ', '
#             + str(round(bellon_t2_index[i], decimal)) + ')', xy=(bellon_t2_2[i], bellon_t2_index[i]),
#             xytext=(bellon_t2_2[i] - 0.035, bellon_t2_index[i] + 4),
#             arrowprops=dict(arrowstyle="->", connectionstyle="arc3"))
